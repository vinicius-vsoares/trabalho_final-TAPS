...
public class FormularioVisualizacaoAluno extends JFrame {
	...
	private JMenuItem menuSair, menuPaginaInicial, menuSobre;
	...
	public FormularioVisualizacaoAluno() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(FormularioVisualizacaoAluno.class.getResource("/fig/icon_projeto.png")));
		...
		menuPaginaInicial = new JMenuItem("P\u00E1gina inicial");
		try {
			menuPaginaInicial.setIcon(new ImageIcon(ImageIO.read(TelaMenu.class.getResource("/fig/homepage.png"))
					.getScaledInstance(15, 15, Image.SCALE_DEFAULT)));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		menuPaginaInicial.setFont(new Font("Segoe UI", Font.PLAIN, 16));
		mnMenu.add(menuPaginaInicial);

		menuSair = new JMenuItem("Sair");
		try {
			menuSair.setIcon(new ImageIcon(ImageIO.read(TelaMenu.class.getResource("/fig/exit.png"))
					.getScaledInstance(15, 15, Image.SCALE_DEFAULT)));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		menuSair.setFont(new Font("Segoe UI", Font.PLAIN, 16));
		mnMenu.add(menuSair);

		menuSobre = new JMenuItem("Sobre");
		try {
			menuSobre.setIcon(new ImageIcon(ImageIO.read(TelaMenu.class.getResource("/fig/about.png"))
					.getScaledInstance(15, 15, Image.SCALE_DEFAULT)));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		menuSobre.setFont(new Font("Segoe UI", Font.PLAIN, 16));
		mnMenu.add(menuSobre);
		...
		panel.setLayout(new MigLayout("", "[grow]",
				"[][][][][][90px:n,fill][][120px:120px][][][][][][][][][][][][90px:n,grow][][90px:n][]"));
		...
		table.setModel(new DefaultTableModel(
				new Object[][] { { "1", null, null, null }, { "2", null, null, null }, { "3", null, null, null },
						{ "4", null, null, null }, { "5", null, null, null }, { "6", null, null, null },
						{ "7", null, null, null }, },
				new String[] { "M\u00F3dulo", "Per\u00EDodo", "\u00C1rea",
						"\u00C1rea Espec\u00EDfica (Med.Interna)" }) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1L;
